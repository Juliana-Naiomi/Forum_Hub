...
import br.com.alura.forumHub.dto.request.TopicoDto;
import br.com.alura.forumHub.dto.response.TopicoDetalhamentoDto;
import br.com.alura.forumHub.dto.response.TopicoListAtivosDto;
import br.com.alura.forumHub.dto.response.TopicoListDto;
...
public class TopicoController {
    ...
    @GetMapping("/lista")
    public ResponseEntity<Page<TopicoListAtivosDto>> listarTopicosAtivos(
        ...
        Page<TopicoListAtivosDto> topicosPage = service.getAllTopicosAtivos(pageable, cursoNome, ano);
